...
const WorkHoursChart: React.FC<WorkHoursChartProps> = ({ logs, profile, t, language }) => {
  ...
  if (chartData.length < 2) {
    return (
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-6 sm:p-8 rounded-2xl shadow-2xl shadow-shadow-color-light dark:shadow-shadow-color-dark w-full h-full flex flex-col items-center justify-center min-h-[380px]">
  ...
  return (
    <div ref={chartRef} className="relative bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-6 sm:p-8 rounded-2xl shadow-2xl shadow-shadow-color-light dark:shadow-shadow-color-dark w-full">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">{t('recentWorkHours')}</h2>
