...
const LoginPage: React.FC<LoginPageProps> = ({ language, setLanguage, theme, setTheme, t, firebaseInitialized, onGuestLogin, onConfigureRequest }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
            ...
            <main className="w-full max-w-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-2xl shadow-shadow-color-light dark:shadow-shadow-color-dark p-8 text-center">
