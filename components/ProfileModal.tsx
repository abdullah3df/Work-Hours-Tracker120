...
const ProfileModal: React.FC<ProfileModalProps> = ({ isOpen, onClose, settings, onSave, t, showToast }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/75 flex justify-center items-center z-50 p-4">
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-2xl w-full max-w-md">
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
             ...
             <div>
              <label htmlFor="totalVacationDaysPerYear" className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('totalVacationDaysPerYear')}</label>
              <input
                type="number"
                id="totalVacationDaysPerYear"
                value={currentSettings.totalVacationDaysPerYear || ''}
